...
namespace ALC.Core.ViewModels.Message
{
    public class Logger : ViewModelBase
    {
        ...
        public bool DialogIsOpen
        {
            ...
            {
                _dialogIsOpen = value;
                OnShouldMessageBoxPopupChanged(_dialogIsOpen);
            }
        }
        ...
        public PopupViewModel PopupViewModel
        {
            ...
            set
            {
                ...
                if(_popupViewModel!=null)DialogIsOpen = true;
            }
        }
        ...
        public static void StartPopupQueue()
        {
            ...
            Instance._popupQueue.NewPopupDequeued += Instance.UpdatePopupViewModel;
        }
